...
HIDDEN_SKILLS = {
    ...
    SKILLS.INSURANCE_AGENT,
    SKILLS.BLACKSMITH,
    SKILLS.CAT_BURGLAR,
    SKILLS.SOFTWARE_ENGINEER,
    SKILLS.PRIVATE_INVESTIGATOR,
    SKILLS.MINER,
    SKILLS.ACTOR,
    SKILLS.ASTRONOMER,
    SKILLS.POLITICIAN,
...
SKILL_PREREQS = {
    ...
    SKILLS.COMMUNICATION_3: [SKILLS.COMMUNICATION_2],
...
SKILL_STAT_PREREQS = {
    ...
    SKILLS.COMMUNICATION_3: {STATS.CHA: 18},
